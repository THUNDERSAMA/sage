      ...
      <div className="container">
        ...
        <div className="row">
          ...
          <div className="col-2">
            ...
            <p className="details">
              Beloved, novel by Toni Morrison, published in 1987 and winner of
              the 1988 Pulitzer Prize for fiction. The work examines the
              destructive legacy of slavery as it chronicles the life of a Black
              woman named Sethe, from her pre-Civil War days as a slave in
